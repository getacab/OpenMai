...
public class Capabilities{
	...
	public String readOrganizationCapabilities() {
		return "readOrganizationCapabilities";
	}
    @GetMapping("/environments/{envID}/capabilities")
	public String readEnvironmentsCapabilities() {
		return "readEnvironmentsCapabilities";
	}
